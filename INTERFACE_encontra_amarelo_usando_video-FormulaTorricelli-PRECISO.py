...
def digitar_tamanho():
    ...
    # Variável que irá armazenar a distância inserida pelo usuário
    distancia = tk.DoubleVar()

    # Função que será chamada quando o usuário clicar no botão "OK"
    def on_ok():
        # Armazenar o valor inserido pelo usuário na variável distancia
        distancia.set(entrada.get())
        # Destruir a janela após o usuário clicar em "OK"
    ...
    # Esta linha faz com que o código aguarde a janela ser destruída antes de continuar
...
# Função para encontrar o contorno do objeto amarelo
...
# Variáveis para o cálculo da aceleração
tempos = []
aceleracoes = []
...
while True:
    ...
    # Desenhar os pontos de calibração sempre
